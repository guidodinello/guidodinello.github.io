...
const email = "guido.dinello@gmail.com";
...
<footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top row bg-light">
    ...
    <div class="col-sm-4 order-2 order-sm-0 d-flex justify-content-center  align-items-center">
        <small class="mb-3 mb-md-0 text-muted">© 2023 All rights reserved</small>
    </div>

    <a href="mailto:${email}?subject=Contact%20from%20personal%20website"
        ...
        <span>Guido</span><br>
        <span class="text-muted fw-light" style="font-size:14px;"><u>${email}</u></span>
        </div>
    </a>

    <ul
        id="contactList" class="nav col-sm-4 order-0 order-sm-2 justify-content-center list-unstyled mb-3 mb-sm-0 d-flex grow-icons">
